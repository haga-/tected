...
public class MainActivity extends AppCompatActivity implements SmartCustomLoginListener{ //implements OnMapReadyCallback
    ...
    public boolean customSignup(SmartUser smartUser) {
        ...
        Log.d("Main", "sign up com implements");
        return true;
    }
